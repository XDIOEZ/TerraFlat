...
> 最后核对：2026-07-30。导航节点更新请同时加载 `flatworld-navigation`。
...
- 基础测试脚本：`Assets/GameTest/Map/MapSmokeTests.cs`；当前基础覆盖 ChunkMgr、Chunk、Map、地图 Prefab、MapCore 环境噪声通道、非法 Perlin 参数有限值保护、世界坐标缩放规则、结构目录入口，以及遗迹容器配置深复制与内容哈希。
