...
- 规范、命名、参考职责或 UI 导入契约变化时同步更新本 Skill；“近期变更”最多保留 5 条，按新到旧排列。

## 近期变更

- 2026-08-12：根据铁匠立绘的“AI 生成感”反馈新增作者化独立游戏模式，以形状语言、因果性非对称、细节预算和渲染层级替代模板脸、英雄体型、表面噪声与配件堆叠。
- 2026-08-12：按规范生成并验收铁匠 `Portrait`，补充了无既有身份图时以最小原创职业锚点定稿、再通过单点构图迭代满足安全留白的实践记录。
- 2026-08-12：从原综合美术 Skill 独立拆出高清角色立绘流程，彻底移除运行时像素尺寸、调色板、动画与导入规则。
- 2026-08-12：新增严格平涂立绘模式，规定大片固有色、单档硬边阴影与有限纯色高光，并禁止用柔和渐变或仅降低光泽冒充平涂。
- 2026-08-12：根据商人立绘反馈补充清爽哑光表现规则，限制蜡感皮肤、塑料头发、湿亮皮具、过量暖色罩染与密集碎褶皱。
