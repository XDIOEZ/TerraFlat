...
* [X] 再添加一个操作啊，就是UI操作，就是长按一个物品，长按的久一点，然后拖动就是拿起一半的物品就是拖动一半的物品。短一点就是直接全部拿起。短一点的全部那一些已经实现了呀，你只要实现前面那个拿起一半的物品的逻辑就可以了。
* [X] 游戏经常出现了摆好配方之后无法识别的问题啊，你解决一下。![1786981836286](image/随手小计/1786981836286.png)
