...
namespace Gaskellgames
{
    ...
    public class AudioSourceData
    {
#if UNITY_EDITOR
        [SerializeField]
        [Tooltip("Reference to an AudioSource: Used in editor only to save/load the _data to/from.")]
        ...
        [Tooltip("Sets the frequency of the sound. Click this to slow down or speed up the sound.")]
        public float pitch;
        ...
        [SerializeField]
        [Tooltip("Which _type of rolloff curve to use.")]
        ...
        [SerializeField]
        [Tooltip("MaxAttackDistance is the distance a sound stops attenuating at.")]
        ...
        /// <summary>
        /// Create a new AudioSourceData using the _data from an AudioSource.
        /// </summary>
        ...
        /// <summary>
        /// Set the values of this AudioSourceData instance using the _data from an AudioSource.
        /// </summary>
        /// <param name="audioSource"></param>
        ...
        /// <summary>
        /// Set the values of an AudioSource using the _data from this AudioSourceData instance.
        /// </summary>
        /// <param name="audioSource"></param>
