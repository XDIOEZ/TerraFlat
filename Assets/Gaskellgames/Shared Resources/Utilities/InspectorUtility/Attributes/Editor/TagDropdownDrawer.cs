        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            if (property.propertyType == SerializedPropertyType.String)
            {
                ...
                else
                {
                    ...
                    if (propertyString == "")
                    {
                        index = 0; // first CurrentIndex is a special case: Untagged
                    }
                    else
                    {
                        // check if entry matches and get the CurrentIndex
                    ...
                    // draw the popup box with the current selected CurrentIndex
