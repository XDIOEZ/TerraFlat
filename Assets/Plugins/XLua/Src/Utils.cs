...
namespace XLua
{
	...
	public static partial class Utils
	{
			...
			int obj_field, int obj_getter, int obj_setter, int obj_meta, out LuaCSFunction item_getter, out LuaCSFunction item_setter, BindingFlags access)
		{
            ...
            System.Reflection.EventInfo[] all_events = type.GetEvents(flag | BindingFlags.Public | BindingFlags.NonPublic);
            ...
            System.Reflection.EventInfo[] events = type.GetEvents(flag);
			for (int i = 0; i < events.Length; ++i)
			{
                System.Reflection.EventInfo eventInfo = events[i];
