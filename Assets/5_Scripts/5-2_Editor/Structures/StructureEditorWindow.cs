...
public sealed class StructureEditorWindow : EditorWindow
{
    ...
    private const string DefinitionFolder = "Assets/4_ScriptObjects/4-9_Structures/Definitions";
    private const string TemplateFolder = "Assets/4_ScriptObjects/4-9_Structures/Templates";
