...
namespace FlatWorld.AIECS
{
    ...
    {
        private const float ShallowWaterSpeedMultiplier = 0.5f; // 与当前 WorldLiquidBehaviour 默认浅水倍率一致。
        private const float DeepWaterSpeedMultiplier = 0.2f; // 与当前 WorldLiquidBehaviour 默认深水倍率一致。
