Shader "FlatWorld/2D/Chunk BRG Water Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct Varyings { float4 positionCS:SV_POSITION; float2 uv:TEXCOORD0; half2 lightingUV:TEXCOORD1; half4 shore:TEXCOORD2; half4 depth:TEXCOORD3; float2 positionWS:TEXCOORD4; half4 tint:COLOR; };
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _ FLATWORLD_WATER_STYLIZED
            struct Attributes { float3 positionOS:POSITION; half4 color:COLOR; float2 uv:TEXCOORD0; UNITY_VERTEX_INPUT_INSTANCE_ID };
            struct Varyings { float4 positionCS:SV_POSITION; float2 uv:TEXCOORD0; half4 shore:TEXCOORD1; half4 depth:TEXCOORD2; float2 positionWS:TEXCOORD3; float2 screenUV:TEXCOORD4; half4 tint:COLOR; };
            Varyings Vert(Attributes input)
            {
                UNITY_SETUP_INSTANCE_ID(input);
                ChunkBRGInstanceData d = LoadChunkBRGInstanceData();
