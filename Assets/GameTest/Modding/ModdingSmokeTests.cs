...
namespace FlatWorld.GameTest.Modding
{
    ...
    public sealed class ModdingSmokeTests
    {
        ...
        public void RequiredEntryPointsExist()
        {
            ...
            GameTestAssertions.AssertAssetExists("Assets/Editor/FlatWorld/ProjectTools/Mods/ModTemplateCreator.cs");
            GameTestAssertions.AssertAssetExists("Assets/2_Prefabs/Gameplay/Modules/Extensibility/Mod_LuaBehaviour.prefab");
        }
    ...
    'modules': { 'lua': {
      ...
      'parameters': { 'scriptPath': 'Lua/actor.lua' }
            ...
            GameObject luaPrefab = AssetDatabase.LoadAssetAtPath<GameObject>(
                "Assets/2_Prefabs/Gameplay/Modules/Extensibility/Mod_LuaBehaviour.prefab");
